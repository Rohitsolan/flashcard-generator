...
import Tab from "../Components/assets/tab.jpg";
  ...
  return (
    <div className="flex flex-col text-slate-600">
      ...
      <div className="  mt-6 md:grid grid-rows-1 grid-cols-4">
        ...
        <div className="mb-5  col-span-3 md:col-span-2 flex  flex-col 2xl:flex-row xl:flex-row lg:flex-row md:flex-row sm:flex-row items-center w-full bg-white shadow-lg rounded-lg">
        ...
        <div className="ml-5 col-span-1 flex flex-row flex-wrap  items-center justify-center md:flex md:flex-col  space-y-2 ">
          <button
            title="Share"
            type="button"
            onClick={() => setShowShare(!showShare)}
            className="flex items-center  p-3 xl:w-60 space-x-4 bg-white rounded-md shadow-lg  transition-all duration-100 hover:scale-105"
          >
