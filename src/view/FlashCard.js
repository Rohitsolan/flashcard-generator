...
import DefaultImg from "../Components/assets/DefaultImg.jpg";
// import { BsTrashFill } from "react-icons/bs";
import { useDispatch } from "react-redux";
import { deleteFlashCard, updateState } from "../Redux/flashcardSlice";
      ...
      <Modal open={showDelete}>
        ...
        <Modal.Body>
          <div className="p-2 text-center">
            <svg
              aria-hidden="true"
              className="mx-auto mb-4 text-gray-400 w-14 h-14 dark:text-gray-400"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            ...
            <h3 className="mb-5 text-lg font-semibold text-gray-600 dark:text-gray-600">
